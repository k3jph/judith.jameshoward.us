...
export const metadata: Metadata = { title: "Gallery", description: "Browse Judith and Holofernes across nine represented centuries by date, scene, medium, artist, geography, and theme." };
